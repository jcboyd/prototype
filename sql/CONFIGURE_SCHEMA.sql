...
CREATE TABLE users (UserID VARCHAR(64), Points INT DEFAULT 0, Rating INT DEFAULT 0, Position INT DEFAULT 1, Notify INT DEFAULT 0, Mute INT DEFAULT 0, NumReports INT DEFAULT 0, Language INT, PRIMARY KEY(UserID), FOREIGN KEY (Language) REFERENCES languages (ID));
