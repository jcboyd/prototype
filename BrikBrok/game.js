...
function Brick(x, y) {
	...
	this.drawAndCollide = function() {
		...
		//i.e. not collision... if execution passes these conditions, there is a collision
...
registerMouseMove(document.getElementById("gameZone"), function(posx, posy, previousX, positionY) {
